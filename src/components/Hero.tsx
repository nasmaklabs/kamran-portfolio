            ...
            >
              ...
              >
                ...
                <motion.a
                  ...
                  className="group inline-flex items-center px-8 py-4 text-lg font-medium rounded-full bg-[rgba(101, 38, 150, 0.94)] text-white backdrop-blur-sm hover:bg-white/20 transition-all duration-300"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
